...
describe StudentsController do
    ...
    describe 'POST login' do
        ...
        it 'should not login an student that has not created an account' do
            post :login, params: {student: {:name => student.name, :uni => "fake1234@columbia.edu", :password => ""}}
            expect(response).to redirect_to(root_path)
        end
    end
    ...
    describe 'POST update_schedule' do
        student = Student.create({name: "test", uni: "ab4699@columbia.edu", password: "password"})
        d = Date.new(1996,1,1)
        timeblock1 = {:weekday => "Monday", "busy_start(4i)": d.beginning_of_day.hour, "busy_start(5i)": d.beginning_of_day.min, "busy_end(4i)": d.end_of_day.hour, "busy_start(5i)": d.end_of_day.min}
        timeblock2 = {:weekday => "Tuesday", "busy_start(4i)": d.beginning_of_day.hour, "busy_start(5i)": d.beginning_of_day.min, "busy_end(4i)": d.end_of_day.hour, "busy_start(5i)": d.end_of_day.min}
        timeblock3 = {:weekday => "Wednesday", "busy_start(4i)": d.beginning_of_day.hour, "busy_start(5i)": d.beginning_of_day.min, "busy_end(4i)": d.end_of_day.hour, "busy_start(5i)": d.end_of_day.min}
        timeblock4 = {:weekday => "Thursday", "busy_start(4i)": d.beginning_of_day.hour, "busy_start(5i)": d.beginning_of_day.min, "busy_end(4i)": d.end_of_day.hour, "busy_start(5i)": d.end_of_day.min}
        timeblock5 = {:weekday => "Friday", "busy_start(4i)": d.beginning_of_day.hour, "busy_start(5i)": d.beginning_of_day.min, "busy_end(4i)": d.end_of_day.hour, "busy_start(5i)": d.end_of_day.min}
        timeblock6 = {:weekday => "Saturday", "busy_start(4i)": d.beginning_of_day.hour, "busy_start(5i)": d.beginning_of_day.min, "busy_end(4i)": d.end_of_day.hour, "busy_start(5i)": d.end_of_day.min}
        timeblock7 = {:weekday => "Sunday", "busy_start(4i)": d.beginning_of_day.hour, "busy_start(5i)": d.beginning_of_day.min, "busy_end(4i)": d.end_of_day.hour, "busy_start(5i)": d.end_of_day.min}
        ...
        bad_timeblock = {:weekday => "Monday", "busy_start(4i)": d.beginning_of_day.hour, "busy_start(5i)": d.beginning_of_day.min, "busy_end(4i)": d.beginning_of_day.hour, "busy_start(5i)": d.beginning_of_day.min}
